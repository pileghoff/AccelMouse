...
#define DEVICE_NAME                     "Accel_mouse"                             /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME               "Pil Eghoff"                      /**< Manufacturer. Will be passed to Device Information Service. */
